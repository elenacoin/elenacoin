...
#if defined(NDEBUG)
# error "ElenaCoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "ElenaCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nHeight, int64_t nFees)
{
	...
	if (nHeight > 4000)				// No PoW after block 4000   
        return 0;
	else if (nHeight > 2000)		// Block 2001 - 4000: 50,000 ELENA COINS
		nSubsidy = 50000 * COIN;
	else if (nHeight > 1000)		// Block 1001 - 2000: 20,000 ELENA COINS
		nSubsidy = 20000 * COIN;
	else if (nHeight > 100)			// Block 101 - 1000: 10,000 ELENA COINS
		nSubsidy = 10000 * COIN;
	else							// Block 1 - 100 : 1 ELENA COIN to avoid instamine
		nSubsidy = 1 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    if (IsProofOfWork())
    {
		// no PoW after block 4000
		if (pindex->nHeight > 4000)
			return DoS(100, error("ConnectBlock() : PoW period ended"));
...
{
    RenameThread("elenacoin-loadblk");
